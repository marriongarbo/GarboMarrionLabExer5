...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    int[] logo = {R.drawable.icbc, R.drawable.apple, R.drawable.wellsfargo,
            R.drawable.royaldutchshell, R.drawable.bankofamerica, R.drawable.jpmorgan,
            R.drawable.att, R.drawable.agricultural, R.drawable.microsoft,
            R.drawable.bankofamerica, R.drawable.toyota, R.drawable.chevron, R.drawable.bp,
            R.drawable.total, R.drawable.amazon};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < comName.length; i++) {
            versions.add(new com.example.garbomarrionlabexer4.AndroidVersion(logo[i], comName[i], industry[i], country[i], ceo[i]));
        }
